...
class CategoryService extends BaseService
{
    ...
    public function createCategory(array $data = [], $type = null): Category
    {
        ...
        $data['slug_en'] = $this->cekSlug(isset($data['slug_en']) ? Str::slug($data['slug_en']) : Str::slug($data['name_en']));
    ...
    public function updateCategory(Category $postCategory, array $data = []): Category
    {
        ...
        $data['slug_en'] = isset($data['slug_en']) ? $data['slug_en'] : Str::slug($data['name_en'] ?? "");
