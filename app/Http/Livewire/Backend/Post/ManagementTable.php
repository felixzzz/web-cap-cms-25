...
class ManagementTable extends DataTableComponent
{
    ...
    public function reorder($items): void
    {
        ...
        foreach ($items as $item) {
            ...
            if ($order === 0) {
                $newSortValue = $maxSortValue + 1;
                Post::find($value)->update(['sort' => $newSortValue]);
            } else {
                Post::find($value)->update(['sort' => $order]);
            }
        }
    }
}
