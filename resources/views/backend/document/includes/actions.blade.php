...
@else
    ...
    <div class="menu-item px-3">
        <a href="{{ route('admin.document.edit', ['document' => $model, 'template' => $template]) }}" class="menu-link px-3">
            Edit
        </a>
    </div>
    ...
    <div class="menu-item px-3">
        <div class="menu-content px-3 py-3">
            <div class="">
                <x-utils.delete-button :href="route('admin.document.destroy', ['document' => $model, 'template' => $template])" />
            </div>
        </div>
    </div>
</div>
