                ...
                <div class="card card-flush p-3">
                    <div class="card-body p-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" name="maintain_aspect_ratio"
                                   {{old('maintain_aspect_ratio') ? 'checked' : ''}} value="1">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <img style="max-height: 250px" class="img-thumbnail" src="{{session('beforeResize')}}" alt="before resize">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">After Resize</label><br>
                                    <img style="max-height: 250px" class="img-thumbnail" src="{{session('afterResize')}}" alt="before resize">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <img id="previewimage" class="img-thumbnail" src="{{session('beforeCrop','')}}" alt="before crop">
                                </div>
                                @if (session('success.crop_image'))
                                <div class="col-6">
                                    <label class="form-label">After Crop</label><br>
                                    <img style="max-height: 250px" class="img-thumbnail" src="{{session('afterCrop')}}" alt="before crop">
                                </div>
                                @endif
                            </div>
                        </div>
