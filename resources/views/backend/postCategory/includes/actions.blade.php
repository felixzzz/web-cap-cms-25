...
@else
    ...
    <div class="separator mb-3 opacity-75"></div>
        <div class="menu-item px-3">
            <a href="{{ route('admin.category.show', [$model, $type]) }}" class="menu-link px-3">
                View
            </a>
        </div>
        <div class="menu-item px-3">
            <a href="{{ route('admin.category.edit', $model) }}" class="menu-link px-3">
                Edit
            </a>
        </div>
    ...
    <div class="menu-item px-3">
        <div class="menu-content px-3 py-3">
            <div class="">
                <x-utils.delete-button :href="route('admin.category.destroy', $model)" />
            </div>
        </div>
    </div>
</div>
