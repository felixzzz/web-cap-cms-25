...
@section('content')
    <x-forms.post :action="route('admin.dynamic.store', ['type' => 'page', 'template' => $template['name']])" enctype="multipart/form-data">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create Business Page')
            </x-slot>
            ...
            <x-slot name="body">
                ...
                <x-forms.text-input name="title_en" label="Title (EN)" required="1" placeholder="The title of page"
                    text="A page name (EN) is required and recommended to be unique." />
