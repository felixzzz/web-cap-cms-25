    ...
    @if ($logged_in_user->hasAllAccess())
        <div style="min-width: 80px">
            <x-utils.form-button-icon
                :action="route($route.'.restore', ['id' => $model])"
                method="patch"
            ...
            <x-utils.delete-button
                :href="route($route.'.permanently-delete', ['id' => $model])"
...
{{--    <div class="menu-item px-3">--}}
{{--        <a href="{{ route('admin.post.show', $model) }}" class="menu-link px-3">--}}
{{--            Show--}}
{{--        </a>--}}
{{--        <a href="{{ route('admin.post.edit', $model) }}" class="menu-link px-3">--}}
{{--            Edit--}}
{{--        </a>--}}
{{--        @if ($model->post_status === 'draft')--}}
{{--            <a href="{{ route('admin.post.status', $model) }}" class="menu-link px-3">--}}
{{--                Publish Post--}}
{{--            </a>--}}
{{--        @elseif ($model->post_status === 'publish')--}}
{{--            <a href="{{ route('admin.post.status', $model) }}" class="menu-link px-3">--}}
{{--                Unpublish Post--}}
{{--            </a>--}}
{{--        @endif--}}
...
{{--            <div class="">--}}
{{--                <x-utils.delete-button :href="route('admin.post.destroy', $model)" />--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
